    ...
    function initSongLibrary() {
        ...
        updateSongBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                console.log('📐 fontSizeSlider element:', fontSizeSlider);
                console.log('📐 fontSizeSlider.value:', fontSizeSlider ? fontSizeSlider.value : 'null');
                console.log('📐 Content length:', content.length);
                console.log('📐 BaselineChart length:', baselineChart.length);
