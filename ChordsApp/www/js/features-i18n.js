...
(function () {
    const T = {
        en: {
            ...
            'f1.title': 'Smart Scanner', 'f1.desc': 'Upload a photo or PDF of any chord chart OR just copy any text with chords. It automatically detects chords, lyrics, key signature, sections, and layout direction — in any language. Try Anything.',
            'f2.title': 'Smart Visual Editor', 'f2.desc': 'Edit chords inline with easy editor. Auto key detection, section markers (Verse, Chorus, Bridge), arrangement badges and smart formatting — all visually in real time.',
            ...
            'f11.title': 'Presenter Mode', 'f11.desc': 'Share a link for projection screens. Presenters join anonymously — no login needed. Lyrics display by default with option to show chords. Follows the leader in real time.',
            'f12.title': 'Singer Mode', 'f12.desc': 'Singers join via a simple link — no account required. They see lyrics only, auto-following the leader\'s song and section selections. Adjustable font size for easy reading on any device.',
            'how.title': 'From photo to stage in minutes', 'how.sub': 'Three key workflows that make Achordim indispensable.',
            'h1.title': 'Scan any chord chart', 'h1.p1': 'Take a photo of a handwritten or printed chord sheet. The smart scanner analyzes it in seconds — detecting chords, lyrics, key, BPM, time signature, and sections. Edit the result visually, then format it perfectly for print.', 'h1.p2': 'Supports Hebrew, English, Spanish, Portuguese, and any language with full RTL support.',
        ...
        he: {
            ...
            'f1.title': 'סורק חכם', 'f1.desc': 'העלה תמונה או PDF של כל דף אקורדים או פשוט העתק טקסט עם אקורדים. המערכת מזהה אוטומטית אקורדים, מילים, סולם, מקטעים וכיוון קריאה — בכל שפה. נסה הכל.',
            'f2.title': 'עורך חזותי חכם', 'f2.desc': 'ערוך אקורדים עם עורך קל ונוח. זיהוי סולם אוטומטי, סמני מקטעים (בית, פזמון, גשר), תגיות מבנה שיר ועיצוב חכם — הכל חזותית בזמן אמת.',
            ...
            'f11.title': 'מצב מגיש', 'f11.desc': 'שתף קישור למסכי הקרנה. מגישים מצטרפים בצורה אנונימית — ללא צורך בהתחברות. מילים מוצגות כברירת מחדל עם אפשרות להציג אקורדים. עוקב אחרי המנהיג בזמן אמת.',
            'f12.title': 'מצב זמר', 'f12.desc': 'זמרים מצטרפים באמצעות קישור פשוט — ללא צורך בחשבון. הם רואים מילים בלבד, עוקבים אוטומטית אחרי בחירת השיר והמקטע של המנהיג. גודל גופן מתכוונן לקריאה נוחה בכל מכשיר.',
            'how.title': 'מצילום לבמה בדקות', 'how.sub': 'שלושה תהליכי עבודה מרכזיים שהופכים את Achordim לבלתי נפרד.',
            'h1.title': 'סרוק כל דף אקורדים', 'h1.p1': 'צלם דף אקורדים בכתב יד או מודפס. המערכת מנתחת אותו בשניות — מזהה אקורדים, מילים, סולם, BPM, משקל ומקטעים. ערוך את התוצאה חזותית ועצב אותה בצורה מושלמת להדפסה.', 'h1.p2': 'תומך בעברית, אנגלית, ספרדית, פורטוגזית וכל שפה עם תמיכה מלאה ב-RTL.',
        ...
        ru: {
            ...
            'f1.title': 'Умный сканер', 'f1.desc': 'Загрузите фото или PDF любого листа аккордов или просто скопируйте текст с аккордами. Система автоматически определяет аккорды, текст, тональность, разделы и направление — на любом языке. Попробуйте что угодно.',
            'f2.title': 'Визуальный редактор', 'f2.desc': 'Редактируйте аккорды в удобном редакторе. Авто-определение тональности, маркеры разделов (Куплет, Припев, Бридж), бейджи аранжировки и умное форматирование — всё визуально, в реальном времени.',
            ...
            'f11.title': 'Режим презентера', 'f11.desc': 'Поделитесь ссылкой для экранов проекции. Презентеры присоединяются анонимно — без входа. Текст отображается по умолчанию с возможностью показать аккорды. Следит за лидером в реальном времени.',
            'f12.title': 'Режим вокалиста', 'f12.desc': 'Вокалисты присоединяются по простой ссылке — без аккаунта. Видят только текст, автоматически следуя за выбором песни и раздела лидера. Настраиваемый размер шрифта для удобного чтения на любом устройстве.',
            'how.title': 'От фото до сцены за минуты', 'how.sub': 'Три ключевых процесса, делающих Achordim незаменимым.',
            'h1.title': 'Сканируй любой лист', 'h1.p1': 'Сфотографируйте рукописный или печатный лист аккордов. Умный сканер анализирует за секунды — определяя аккорды, текст, тональность, BPM, размер и разделы. Отредактируйте визуально и отформатируйте для печати.', 'h1.p2': 'Поддерживает иврит, английский, испанский, португальский и любой язык с полной поддержкой RTL.',
        ...
        es: {
            ...
            'f1.title': 'Escáner inteligente', 'f1.desc': 'Sube una foto o PDF de cualquier hoja de acordes o simplemente copia texto con acordes. El sistema detecta automáticamente acordes, letras, tonalidad, secciones y dirección — en cualquier idioma. Prueba lo que sea.',
            'f2.title': 'Editor visual inteligente', 'f2.desc': 'Edita acordes con un editor fácil. Detección automática de tonalidad, marcadores de sección (Verso, Coro, Puente), insignias de arreglo y formato inteligente — todo visualmente en tiempo real.',
            ...
            'f11.title': 'Modo Presentador', 'f11.desc': 'Comparte un enlace para pantallas de proyección. Los presentadores se unen anónimamente — sin necesidad de iniciar sesión. Las letras se muestran por defecto con opción de mostrar acordes. Sigue al líder en tiempo real.',
            'f12.title': 'Modo Cantante', 'f12.desc': 'Los cantantes se unen mediante un enlace simple — sin necesidad de cuenta. Ven solo las letras, siguiendo automáticamente la selección de canción y sección del líder. Tamaño de fuente ajustable para lectura fácil en cualquier dispositivo.',
            'how.title': 'De la foto al escenario en minutos', 'how.sub': 'Tres flujos de trabajo clave que hacen a Achordim indispensable.',
            'h1.title': 'Escanea cualquier hoja', 'h1.p1': 'Toma una foto de una hoja de acordes. El escáner inteligente la analiza en segundos — detectando acordes, letras, tonalidad, BPM, compás y secciones. Edita visualmente y formatea para imprimir.', 'h1.p2': 'Soporta hebreo, inglés, español, portugués y cualquier idioma con soporte RTL completo.',
        ...
        fr: {
            ...
            'f1.title': 'Scanner intelligent', 'f1.desc': 'Téléchargez une photo ou PDF de toute feuille d\'accords ou copiez simplement du texte avec des accords. Le système détecte automatiquement accords, paroles, tonalité, sections et direction — dans toutes les langues. Essayez tout.',
            'f2.title': 'Éditeur visuel intelligent', 'f2.desc': 'Éditez les accords avec un éditeur simple. Détection automatique de tonalité, marqueurs de section (Couplet, Refrain, Pont), badges d\'arrangement et mise en forme intelligente — en temps réel.',
            ...
            'f11.title': 'Mode Présentateur', 'f11.desc': 'Partagez un lien pour les écrans de projection. Les présentateurs rejoignent anonymement — sans connexion. Les paroles s\'affichent par défaut avec option d\'afficher les accords. Suit le leader en temps réel.',
            'f12.title': 'Mode Chanteur', 'f12.desc': 'Les chanteurs rejoignent via un simple lien — sans compte requis. Ils voient uniquement les paroles, suivant automatiquement la sélection de chanson et de section du leader. Taille de police ajustable pour une lecture facile sur tout appareil.',
            'how.title': 'De la photo à la scène en minutes', 'how.sub': 'Trois processus clés qui rendent Achordim indispensable.',
            'h1.title': 'Scannez toute feuille', 'h1.p1': 'Prenez une photo d\'une feuille d\'accords. Le scanner intelligent l\'analyse en secondes — détectant accords, paroles, tonalité, BPM, mesure et sections. Éditez visuellement puis formatez pour l\'impression.', 'h1.p2': 'Supporte l\'hébreu, l\'anglais, l\'espagnol, le portugais et toute langue avec support RTL complet.',
        ...
        pt: {
            ...
            'f1.title': 'Scanner inteligente', 'f1.desc': 'Envie uma foto ou PDF de qualquer cifra ou simplesmente cole texto com acordes. O sistema detecta automaticamente acordes, letras, tom, seções e direção — em qualquer idioma. Experimente tudo.',
            'f2.title': 'Editor visual inteligente', 'f2.desc': 'Edite acordes com um editor fácil. Detecção automática de tom, marcadores de seção (Verso, Refrão, Ponte), badges de arranjo e formatação inteligente — tudo visualmente em tempo real.',
            ...
            'f11.title': 'Modo Apresentador', 'f11.desc': 'Compartilhe um link para telas de projeção. Apresentadores entram anonimamente — sem login necessário. Letras exibidas por padrão com opção de mostrar acordes. Segue o líder em tempo real.',
            'f12.title': 'Modo Cantor', 'f12.desc': 'Cantores entram por um link simples — sem conta necessária. Veem apenas letras, seguindo automaticamente a seleção de música e seção do líder. Tamanho de fonte ajustável para leitura fácil em qualquer dispositivo.',
            'how.title': 'Da foto ao palco em minutos', 'how.sub': 'Três fluxos de trabalho que tornam o Achordim indispensável.',
            'h1.title': 'Digitalize qualquer cifra', 'h1.p1': 'Tire uma foto de uma cifra. O scanner inteligente analisa em segundos — detectando acordes, letras, tom, BPM, compasso e seções. Edite visualmente e formate para impressão.', 'h1.p2': 'Suporta hebraico, inglês, espanhol, português e qualquer idioma com suporte RTL completo.',
