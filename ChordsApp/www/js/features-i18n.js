...
(function () {
    const T = {
        ...
        ru: {
            ...
            'hero.subtitle': 'Загрузите рукописный лист или фото — ИИ определит аккорды, слова, тональность и разделы. Транспонируйте, форматируйте, печатайте и играйте вживую.',
        ...
        es: {
            ...
            'hero.subtitle': 'Sube una hoja manuscrita o una foto — la IA detecta acordes, letras, tonalidad y secciones. Transpón, formatea, imprime y toca en vivo con tu banda.',
        ...
        fr: {
            ...
            'hero.subtitle': 'Téléchargez une feuille manuscrite ou une photo — l\'IA détecte les accords, paroles, tonalité et sections. Transposez, formatez, imprimez et jouez en live.',
        ...
        pt: {
            ...
            'hero.subtitle': 'Envie uma folha manuscrita ou foto — a IA detecta acordes, letras, tom e seções. Transponha, formate, imprima e toque ao vivo com sua banda.',
