...
(function () {
    const T = {
        en: {
            ...
            'hero.subtitle': 'Upload a handwritten sheet or photo — the system detects chords, lyrics, key and sections. Transpose, format, print, and play live with your band. All in one app.',
        ...
        he: {
            ...
            'hero.subtitle': 'העלה דף בכתב יד או צילום — המערכת מזהה אוטומטית אקורדים, מילים, סולם ומקטעים. טרנספוז, עיצוב, הדפסה ונגינה חיה עם הלהקה. הכל באפליקציה אחת.',
            ...
            'f1.title': 'סורק חכם', 'f1.desc': 'העלה תמונה, קובץ PDF של כל דף אקורדים או פשוט העתק טקסט עם אקורדים. הסורק יזהה אוטומטית את האקורדים, המילים, הסולם, החלקים וכיוון הקריאה - בכל שפה. נסה כל דבר.',
            'f2.title': 'עורך חזותי חכם', 'f2.desc': 'ערוך אקורדים בשורה אחת עם עורך קל ולנוח. זיהוי סולם אוטומטי, סמני מקטעים (בית, פזמון, גשר), תגיות מבנה ועיצוב חכם — הכל חזותית בזמן אמת.',
