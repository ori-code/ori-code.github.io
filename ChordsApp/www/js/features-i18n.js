...
(function () {
    const T = {
        en: {
            ...
            'f1.title': 'Smart Scanner', 'f1.desc': 'Upload a photo or PDF of any chord chart. It automatically detects chords, lyrics, key signature, sections, and layout direction — in any language.',
        ...
        he: {
            ...
            'f1.title': 'סורק חכם', 'f1.desc': 'העלה תמונה או קובץ PDF של כל דף אקורדים. הסורק יזהה אוטומטית את האקורדים, המילים, הסולם, החלקים (בית/פזמון) וכיוון הקריאה - בכל שפה.',
